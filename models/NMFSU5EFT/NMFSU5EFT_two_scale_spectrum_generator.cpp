#include "NMFSU5EFT_two_scale_spectrum_generator.hpp"
...
double NMFSU5EFT_spectrum_generator<Two_scale>::get_pole_mass_scale(
   double susy_scale) const
{
...
double NMFSU5EFT_spectrum_generator<Two_scale>::get_eft_pole_mass_scale(
   double susy_scale, double Mt) const
{
