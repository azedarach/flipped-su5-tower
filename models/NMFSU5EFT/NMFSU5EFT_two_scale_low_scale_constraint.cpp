...
NMFSU5EFT_low_scale_constraint<Two_scale>::NMFSU5EFT_low_scale_constraint(
   cSMHdCKM<Two_scale>* model_, const softsusy::QedQcd& qedqcd_,
   const NMFSU5EFT_input_parameters& input_)
   : model(model_)
   , qedqcd(qedqcd_)
   , input(input_)
{
...
const Eigen::Matrix<std::complex<double>,3,3>& NMFSU5EFT_low_scale_constraint<Two_scale>::get_ckm()
{
   return ckm;
}

const Eigen::Matrix<std::complex<double>,3,3>& NMFSU5EFT_low_scale_constraint<Two_scale>::get_pmns()
{
   return pmns;
}

double NMFSU5EFT_low_scale_constraint<Two_scale>::get_scale() const
{
   return scale;
}

double NMFSU5EFT_low_scale_constraint<Two_scale>::get_initial_scale_guess() const
{
   return initial_scale_guess;
}

void NMFSU5EFT_low_scale_constraint<Two_scale>::set_model(Model* model_)
{
   model = cast_model<cSMHdCKM<Two_scale>*>(model_);
}

void NMFSU5EFT_low_scale_constraint<Two_scale>::set_sm_parameters(
   const softsusy::QedQcd& qedqcd_)
{
   qedqcd = qedqcd_;
}

const softsusy::QedQcd& NMFSU5EFT_low_scale_constraint<Two_scale>::get_sm_parameters() const
{
   return qedqcd;
}

void NMFSU5EFT_low_scale_constraint<Two_scale>::clear()
{
   scale = 0.;
...
void NMFSU5EFT_low_scale_constraint<Two_scale>::initialize()
{
   check_model_ptr();
...
void NMFSU5EFT_low_scale_constraint<Two_scale>::update_scale()
{
   check_model_ptr();
...
void NMFSU5EFT_low_scale_constraint<Two_scale>::calculate_threshold_corrections()
{
   check_model_ptr();
...
double NMFSU5EFT_low_scale_constraint<Two_scale>::calculate_theta_w()
{
   check_model_ptr();
...
void NMFSU5EFT_low_scale_constraint<Two_scale>::calculate_DRbar_gauge_couplings()
{
   check_model_ptr();
...
double NMFSU5EFT_low_scale_constraint<Two_scale>::calculate_delta_alpha_em(double alphaEm) const
{
   check_model_ptr();
...
double NMFSU5EFT_low_scale_constraint<Two_scale>::calculate_delta_alpha_s(double alphaS) const
{
   check_model_ptr();
...
double NMFSU5EFT_low_scale_constraint<Two_scale>::calculate_alpha_s_SM5_at(
...
void NMFSU5EFT_low_scale_constraint<Two_scale>::calculate_running_SM_masses()
{
   check_model_ptr();
...
void NMFSU5EFT_low_scale_constraint<Two_scale>::calculate_Kappa()
{
   const auto v = MODELPARAMETER(v);
...
void NMFSU5EFT_low_scale_constraint<Two_scale>::calculate_neutrino_basis()
{
...
void NMFSU5EFT_low_scale_constraint<Two_scale>::calculate_neutrino_mixing()
{
...
void NMFSU5EFT_low_scale_constraint<Two_scale>::calculate_DRbar_yukawa_couplings()
{
   calculate_running_SM_masses();
   calculate_neutrino_basis();
   calculate_neutrino_mixing();
...
void NMFSU5EFT_low_scale_constraint<Two_scale>::calculate_Yu_DRbar()
{
   check_model_ptr();
...
void NMFSU5EFT_low_scale_constraint<Two_scale>::calculate_Yd_DRbar()
{
   check_model_ptr();
...
void NMFSU5EFT_low_scale_constraint<Two_scale>::calculate_Ye_DRbar()
{
   check_model_ptr();
...
void NMFSU5EFT_low_scale_constraint<Two_scale>::check_model_ptr() const
{
   if (!model)
      throw SetupError("NMFSU5EFT_low_scale_constraint<Two_scale>: "
