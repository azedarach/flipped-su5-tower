...
/**
 * @file cSMHdCKMRHN_mass_eigenstates.hpp
 *
...
#ifndef cSMHdCKMRHN_MASS_EIGENSTATES_H
#define cSMHdCKMRHN_MASS_EIGENSTATES_H
 ...
 */
class cSMHdCKMRHN_mass_eigenstates : public cSMHdCKMRHN_soft_parameters {
public:
   explicit cSMHdCKMRHN_mass_eigenstates(const cSMHdCKMRHN_input_parameters& input_ = cSMHdCKMRHN_input_parameters());
   cSMHdCKMRHN_mass_eigenstates(const cSMHdCKMRHN_mass_eigenstates&) = default;
   cSMHdCKMRHN_mass_eigenstates(cSMHdCKMRHN_mass_eigenstates&&) = default;
   virtual ~cSMHdCKMRHN_mass_eigenstates() = default;
   cSMHdCKMRHN_mass_eigenstates& operator=(const cSMHdCKMRHN_mass_eigenstates&) = default;
   cSMHdCKMRHN_mass_eigenstates& operator=(cSMHdCKMRHN_mass_eigenstates&&) = default;
   ...
   void set_physical(const cSMHdCKMRHN_physical&);
   double get_ewsb_iteration_precision() const;
   double get_ewsb_loop_order() const;
   const cSMHdCKMRHN_physical& get_physical() const;
   cSMHdCKMRHN_physical& get_physical();
   const Problems& get_problems() const;
   Problems& get_problems();
   void set_ewsb_solver(const std::shared_ptr<cSMHdCKMRHN_ewsb_solver_interface>&);
   ...
   std::complex<double> CpFvFeconjHmPR(int gI1, int gI2) const;
   std::complex<double> CpFvFeconjHmPL(int gI1, int gI2) const;
   ...
   std::complex<double> CpFvFvAhPR(int gI1, int gI2) const;
   std::complex<double> CpFvFvAhPL(int gI1, int gI2) const;
   ...
   std::complex<double> CpFvFvhhPR(int gI1, int gI2) const;
   std::complex<double> CpFvFvhhPL(int gI1, int gI2) const;
   ...
   std::complex<double> CpbarUFeFvHmPR(int gO1, int gI2) const;
   double CpbarUFeFvconjVWpPR(int , int ) const;
   std::complex<double> CpbarUFeFvconjVWpPL(int gO1, int gI2) const;
   std::complex<double> CpbarFeUFvHmPL(int gI1, int gO2) const;
   std::complex<double> CpbarFeUFvHmPR(int gI1, int gO1) const;
   std::complex<double> CpFvUFvAhPL(int gI1, int gO2) const;
   std::complex<double> CpFvUFvAhPR(int gI1, int gO1) const;
   std::complex<double> CpbarFeUFvconjVWpPL(int gI2, int gO2) const;
   double CpbarFeUFvconjVWpPR(int , int ) const;
   double CpUFvFeVWpPR(int , int ) const;
   std::complex<double> CpUFvFeVWpPL(int gO1, int gI2) const;
   std::complex<double> CpUFvFeconjHmPL(int gO2, int gI2) const;
   std::complex<double> CpUFvFeconjHmPR(int gO1, int gI2) const;
   std::complex<double> CpFvUFvhhPL(int gI2, int gO2) const;
   std::complex<double> CpFvUFvhhPR(int gI2, int gO1) const;
   ...
   std::complex<double> CpbarFeFvHmPR(int gO1, int gI2) const;
...
private:
   ...
   cSMHdCKMRHN_physical physical{}; ///< contains the pole masses and mixings
   Problems problems{cSMHdCKMRHN_info::model_name,
                     &cSMHdCKMRHN_info::particle_names_getter,
                     &cSMHdCKMRHN_info::parameter_names_getter}; ///< problems
   Loop_corrections loop_corrections{}; ///< used pole mass corrections
   std::shared_ptr<cSMHdCKMRHN_ewsb_solver_interface> ewsb_solver{};
...
std::ostream& operator<<(std::ostream&, const cSMHdCKMRHN_mass_eigenstates&);
