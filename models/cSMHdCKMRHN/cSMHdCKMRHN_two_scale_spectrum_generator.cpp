...
double cSMHdCKMRHN_spectrum_generator<Two_scale>::get_pole_mass_scale() const
{
 ...
 */
void cSMHdCKMRHN_spectrum_generator<Two_scale>::run_except(const softsusy::QedQcd& qedqcd,
                                const cSMHdCKMRHN_input_parameters& input)
{
   ...
   cSMHdCKMRHN_low_scale_constraint<Two_scale>  low_scale_constraint(&model, qedqcd);

   high_scale_constraint.initialize();
   susy_scale_constraint.initialize();
   low_scale_constraint .initialize();

   cSMHdCKMRHN_convergence_tester<Two_scale> convergence_tester(
   ...
   cSMHdCKMRHN_initial_guesser<Two_scale> initial_guesser(&model, qedqcd,
 ...
 */
void cSMHdCKMRHN_spectrum_generator<Two_scale>::write_running_couplings(
   const std::string& filename) const
{
   cSMHdCKMRHN_spectrum_generator_interface<Two_scale>::write_running_couplings(
      filename, get_low_scale(), get_high_scale());
}

void cSMHdCKMRHN_spectrum_generator<Two_scale>::calculate_spectrum()
{
