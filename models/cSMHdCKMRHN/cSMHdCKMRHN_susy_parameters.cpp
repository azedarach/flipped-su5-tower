...
#define CLASSNAME cSMHdCKMRHN_susy_parameters
#define INPUT(parameter) input.parameter
#define TRACE_STRUCT susy_traces
#define TRACE_STRUCT_TYPE Susy_traces
#define CALCULATE_TRACES(l) calc_susy_traces(l);

const int cSMHdCKMRHN_susy_parameters::numberOfParameters;

cSMHdCKMRHN_susy_parameters::cSMHdCKMRHN_susy_parameters(const cSMHdCKMRHN_input_parameters& input_)
   : input(input_)
{
   set_number_of_parameters(numberOfParameters);
}

cSMHdCKMRHN_susy_parameters::cSMHdCKMRHN_susy_parameters(
   double scale_, int loops_, int thresholds_,
   const cSMHdCKMRHN_input_parameters& input_
   ...
   : Beta_function()
   , g1(g1_), g2(g2_), g3(g3_), Lambdax(Lambdax_), Yd(Yd_), Ye(Ye_), Yv(Yv_), Yu(
   Yu_)
   , input(input_)
{
   set_number_of_parameters(numberOfParameters);
...
Eigen::ArrayXd cSMHdCKMRHN_susy_parameters::beta() const
{
   return calc_beta().get().unaryExpr(Chop<double>(get_zero_threshold()));
}

cSMHdCKMRHN_susy_parameters cSMHdCKMRHN_susy_parameters::calc_beta(int loops) const
{
   double beta_g1 = 0.;
   double beta_g2 = 0.;
   double beta_g3 = 0.;
   ...
   Eigen::Matrix<std::complex<double>,3,3> beta_Ye = Eigen::Matrix<std::complex<
      double>,3,3>::Zero();
   Eigen::Matrix<std::complex<double>,3,3> beta_Yv = Eigen::Matrix<std::complex<
      double>,3,3>::Zero();
   ...
   return cSMHdCKMRHN_susy_parameters(get_scale(), loops, get_thresholds(), input,
                    beta_g1, beta_g2, beta_g3, beta_Lambdax, beta_Yd, beta_Ye, beta_Yv, beta_Yu);
}

cSMHdCKMRHN_susy_parameters cSMHdCKMRHN_susy_parameters::calc_beta() const
{
   return calc_beta(get_loops());
}

void cSMHdCKMRHN_susy_parameters::clear()
{
   reset();
   g1 = 0.;
   g2 = 0.;
   ...
   Yv = Eigen::Matrix<std::complex<double>,3,3>::Zero();
...
Eigen::ArrayXd cSMHdCKMRHN_susy_parameters::get() const
{
...
void cSMHdCKMRHN_susy_parameters::print(std::ostream& ostr) const
{
...
void cSMHdCKMRHN_susy_parameters::set(const Eigen::ArrayXd& pars)
{
   g1 = pars(0);
   g2 = pars(1);
   g3 = pars(2);
   ...
   Yv(0,0) = std::complex<double>(pars(40), pars(41));
   Yv(0,1) = std::complex<double>(pars(42), pars(43));
   Yv(0,2) = std::complex<double>(pars(44), pars(45));
   Yv(1,0) = std::complex<double>(pars(46), pars(47));
   Yv(1,1) = std::complex<double>(pars(48), pars(49));
   Yv(1,2) = std::complex<double>(pars(50), pars(51));
   Yv(2,0) = std::complex<double>(pars(52), pars(53));
   Yv(2,1) = std::complex<double>(pars(54), pars(55));
   Yv(2,2) = std::complex<double>(pars(56), pars(57));
   Yu(0,0) = std::complex<double>(pars(58), pars(59));
   Yu(0,1) = std::complex<double>(pars(60), pars(61));
   Yu(0,2) = std::complex<double>(pars(62), pars(63));
   Yu(1,0) = std::complex<double>(pars(64), pars(65));
   Yu(1,1) = std::complex<double>(pars(66), pars(67));
   Yu(1,2) = std::complex<double>(pars(68), pars(69));
   Yu(2,0) = std::complex<double>(pars(70), pars(71));
   Yu(2,1) = std::complex<double>(pars(72), pars(73));
   Yu(2,2) = std::complex<double>(pars(74), pars(75));

}

const cSMHdCKMRHN_input_parameters& cSMHdCKMRHN_susy_parameters::get_input() const
{
   return input;
}

cSMHdCKMRHN_input_parameters& cSMHdCKMRHN_susy_parameters::get_input()
{
   return input;
}

void cSMHdCKMRHN_susy_parameters::set_input_parameters(const cSMHdCKMRHN_input_parameters& input_)
{
   input = input_;
}

cSMHdCKMRHN_susy_parameters::Susy_traces cSMHdCKMRHN_susy_parameters::calc_susy_traces(int loops) const
{
   ...
   if (loops > 1) {
      ...
      TRACE_STRUCT.traceYeAdjYeYeAdjYeYeAdjYe = Re((Ye*Ye.adjoint()*Ye*Ye.adjoint()*
         Ye*Ye.adjoint()).trace());
      TRACE_STRUCT.traceYeAdjYeYeAdjYvYvAdjYe = Re((Ye*Ye.adjoint()*Ye*Yv.adjoint()*
         Yv*Ye.adjoint()).trace());
      TRACE_STRUCT.traceYeAdjYvYvAdjYeYeAdjYe = Re((Ye*Yv.adjoint()*Yv*Ye.adjoint()*
         Ye*Ye.adjoint()).trace());
      TRACE_STRUCT.traceYeAdjYvYvAdjYvYvAdjYe = Re((Ye*Yv.adjoint()*Yv*Yv.adjoint()*
         Yv*Ye.adjoint()).trace());
      TRACE_STRUCT.traceYuAdjYuYuAdjYuYuAdjYu = Re((Yu*Yu.adjoint()*Yu*Yu.adjoint()*
         Yu*Yu.adjoint()).trace());
      TRACE_STRUCT.traceYvAdjYvYvAdjYvYvAdjYv = Re((Yv*Yv.adjoint()*Yv*Yv.adjoint()*
         Yv*Yv.adjoint()).trace());
...
std::ostream& operator<<(std::ostream& ostr, const cSMHdCKMRHN_susy_parameters& susy_pars)
{
