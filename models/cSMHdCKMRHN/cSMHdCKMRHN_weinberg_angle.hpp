...
#ifndef cSMHdCKMRHN_WEINBERG_ANGLE_H
#define cSMHdCKMRHN_WEINBERG_ANGLE_H
...
/**
 * @class cSMHdCKMRHN_weinberg_angle
...
public:
   ...
   cSMHdCKMRHN_weinberg_angle(const cSMHdCKMRHN_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const cSMHdCKMRHN_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const cSMHdCKMRHN_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
