...
cSMHdCKMRHN_high_scale_constraint<Two_scale>::cSMHdCKMRHN_high_scale_constraint(
...
void cSMHdCKMRHN_high_scale_constraint<Two_scale>::apply()
{
   check_model_ptr();
   ...
   const auto MvInput = INPUTPARAMETER(MvInput);
   const auto Yu = MODELPARAMETER(Yu);
...
bool cSMHdCKMRHN_high_scale_constraint<Two_scale>::check_non_perturbative()
{
   bool problem = false;
...
double cSMHdCKMRHN_high_scale_constraint<Two_scale>::get_scale() const
{
   return scale;
}

double cSMHdCKMRHN_high_scale_constraint<Two_scale>::get_initial_scale_guess() const
{
   return initial_scale_guess;
}

const cSMHdCKMRHN_input_parameters& cSMHdCKMRHN_high_scale_constraint<Two_scale>::get_input_parameters() const
{
   return model->get_input();
}

cSMHdCKMRHN<Two_scale>* cSMHdCKMRHN_high_scale_constraint<Two_scale>::get_model() const
{
   return model;
}

void cSMHdCKMRHN_high_scale_constraint<Two_scale>::set_model(Model* model_)
{
   model = cast_model<cSMHdCKMRHN<Two_scale>*>(model_);
}

void cSMHdCKMRHN_high_scale_constraint<Two_scale>::set_scale(double s)
{
   scale = s;
}

void cSMHdCKMRHN_high_scale_constraint<Two_scale>::clear()
{
   scale = 0.;
...
void cSMHdCKMRHN_high_scale_constraint<Two_scale>::initialize()
{
   check_model_ptr();
...
void cSMHdCKMRHN_high_scale_constraint<Two_scale>::update_scale()
{
   check_model_ptr();
...
void cSMHdCKMRHN_high_scale_constraint<Two_scale>::check_model_ptr() const
{
   if (!model)
      throw SetupError("cSMHdCKMRHN_high_scale_constraint<Two_scale>: "
