...
#ifndef cSMHdCKMRHN_SPECTRUM_GENERATOR_INTERFACE_H
#define cSMHdCKMRHN_SPECTRUM_GENERATOR_INTERFACE_H
...
template <class T>
class cSMHdCKMRHN_spectrum_generator_interface {
public:
   virtual ~cSMHdCKMRHN_spectrum_generator_interface() = default;

   std::tuple<cSMHdCKMRHN<T>> get_models() const
   { return std::make_tuple(model); }
   std::tuple<cSMHdCKMRHN_slha<cSMHdCKMRHN<T>>> get_models_slha() const
   { return std::make_tuple(cSMHdCKMRHN_slha<cSMHdCKMRHN<T> >(model, settings.get(Spectrum_generator_settings::force_positive_masses) == 0.)); }

   const cSMHdCKMRHN<T>& get_model() const
   { return model; }
   cSMHdCKMRHN<T>& get_model()
   { return model; }
   cSMHdCKMRHN_slha<cSMHdCKMRHN<T>> get_model_slha() const
   { return cSMHdCKMRHN_slha<cSMHdCKMRHN<T>>(model, settings.get(Spectrum_generator_settings::force_positive_masses) == 0.); }
   ...
   void run(const softsusy::QedQcd&, const cSMHdCKMRHN_input_parameters&);
   void write_running_couplings(const std::string& filename, double, double) const;
   void write_spectrum(const std::string& filename = "cSMHdCKMRHN_spectrum.dat") const;
...
protected:
   ...
   void translate_exception_to_problem(cSMHdCKMRHN<T>& model);
   virtual void run_except(const softsusy::QedQcd&, const cSMHdCKMRHN_input_parameters&) = 0;
};
 ...
 */
template <class T>
void cSMHdCKMRHN_spectrum_generator_interface<T>::set_settings(
 ...
 */
template <class T>
void cSMHdCKMRHN_spectrum_generator_interface<T>::run(
   const softsusy::QedQcd& qedqcd_, const cSMHdCKMRHN_input_parameters& input)
{
 ...
 */
template <class T>
void cSMHdCKMRHN_spectrum_generator_interface<T>::write_running_couplings(
 ...
 */
template <class T>
void cSMHdCKMRHN_spectrum_generator_interface<T>::write_spectrum(
 ...
 */
template <class T>
void cSMHdCKMRHN_spectrum_generator_interface<T>::translate_exception_to_problem(cSMHdCKMRHN<T>& model)
{
   try {
      throw;
