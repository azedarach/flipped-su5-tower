 ...
 */
double cSMHdCKMRHN_soft_parameters::calc_beta_v_1_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double cSMHdCKMRHN_soft_parameters::calc_beta_v_2_loop(const Soft_traces& soft_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
   ...
   beta_v = Re(-0.00125*twoLoop*v*(1221*Quad(g1) + 10*Sqr(g1)*(122*traceYdAdjYd
       + 174*traceYeAdjYe + 242*traceYuAdjYu + 54*traceYvAdjYv - 45*Sqr(g2)) +
      25*(-379*Quad(g2) + 108*(3*traceYdAdjYd + traceYeAdjYe + 3*traceYuAdjYu +
      traceYvAdjYv)*Sqr(g2) + 8*(-27*traceYdAdjYdYdAdjYd + 6*
      ...
      traceYuAdjYu)*Sqr(g3) + 6*Sqr(Lambdax)))));
 ...
 */
double cSMHdCKMRHN_soft_parameters::calc_beta_v_3_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double cSMHdCKMRHN_soft_parameters::calc_beta_v_4_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
