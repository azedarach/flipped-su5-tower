...
#ifndef cSMHdCKMRHN_TWO_SCALE_INITIAL_GUESSER_H
#define cSMHdCKMRHN_TWO_SCALE_INITIAL_GUESSER_H
...
/**
 * @class cSMHdCKMRHN_initial_guesser<Two_scale>
 * @brief initial guesser for the cSMHdCKMRHN
 */

template<>
class cSMHdCKMRHN_initial_guesser<Two_scale> : public Initial_guesser {
public:
   cSMHdCKMRHN_initial_guesser(cSMHdCKMRHN<Two_scale>*,
                               const softsusy::QedQcd&,
                               const cSMHdCKMRHN_low_scale_constraint<Two_scale>&,
                               const cSMHdCKMRHN_susy_scale_constraint<Two_scale>&,
                               const cSMHdCKMRHN_high_scale_constraint<Two_scale>&);
   virtual ~cSMHdCKMRHN_initial_guesser() = default;
...
private:
   ...
   cSMHdCKMRHN_low_scale_constraint<Two_scale> low_constraint{};
