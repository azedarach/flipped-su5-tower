...
#include "cSMHdCKMRHN_two_scale_initial_guesser.hpp"
...
cSMHdCKMRHN_initial_guesser<Two_scale>::cSMHdCKMRHN_initial_guesser(
   cSMHdCKMRHN<Two_scale>* model_,
   const softsusy::QedQcd& qedqcd_,
   const cSMHdCKMRHN_low_scale_constraint<Two_scale>& low_constraint_,
...
{
   if (!model)
      throw SetupError("cSMHdCKMRHN_initial_guesser: Error: pointer to model"
 ...
 */
void cSMHdCKMRHN_initial_guesser<Two_scale>::guess()
{
 ...
 * \endcode
 */
void cSMHdCKMRHN_initial_guesser<Two_scale>::guess_susy_parameters()
{
...
void cSMHdCKMRHN_initial_guesser<Two_scale>::calculate_DRbar_yukawa_couplings()
{
   calculate_running_SM_masses();
   calculate_Yu_DRbar();
   calculate_Yd_DRbar();
...
void cSMHdCKMRHN_initial_guesser<Two_scale>::calculate_running_SM_masses()
{
 ...
 * corrections).
 */
void cSMHdCKMRHN_initial_guesser<Two_scale>::calculate_Yu_DRbar()
{
 ...
 */
void cSMHdCKMRHN_initial_guesser<Two_scale>::calculate_Yd_DRbar()
{
   const auto v = MODELPARAMETER(v);
 ...
 * corrections).
 */
void cSMHdCKMRHN_initial_guesser<Two_scale>::calculate_Ye_DRbar()
{
   const auto v = MODELPARAMETER(v);
 ...
 */
void cSMHdCKMRHN_initial_guesser<Two_scale>::guess_soft_parameters()
{
