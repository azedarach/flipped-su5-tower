...
{
   std::cout <<
      "Usage: run_cmd_line_cSMHdCKMRHN.x [options]\n"
      "Options:\n"
      "  --LambdaIN=<value>\n"
      "  --Qin=<value>\n"
      "  --QEWSB=<value>\n"
...
int run_solver(const cSMHdCKMRHN_input_parameters& input)
{
   ...
   // SLHA output
   SLHAea::Coll slhaea(cSMHdCKMRHN_slha_io::fill_slhaea(
...
int run(int solver_type, const cSMHdCKMRHN_input_parameters& input)
{
   int exit_code = 0;
