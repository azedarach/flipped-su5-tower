...
#ifndef cSMHdCKMRHN_TWO_SCALE_LOW_SCALE_CONSTRAINT_H
#define cSMHdCKMRHN_TWO_SCALE_LOW_SCALE_CONSTRAINT_H

#include "cSMHdCKMRHN_low_scale_constraint.hpp"
...
template<>
class cSMHdCKMRHN_low_scale_constraint<Two_scale> : public Single_scale_constraint {
public:
   cSMHdCKMRHN_low_scale_constraint() = default;
   cSMHdCKMRHN_low_scale_constraint(cSMHdCKMRHN<Two_scale>*, const softsusy::QedQcd&);
   virtual ~cSMHdCKMRHN_low_scale_constraint() = default;
   virtual void apply() override;
   virtual double get_scale() const override;
   virtual std::string name() const override { return "cSMHdCKMRHN low-scale constraint"; }
