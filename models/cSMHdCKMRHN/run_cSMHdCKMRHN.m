Get["models/cSMHdCKMRHN/cSMHdCKMRHN_librarylink.m"];

handle = FScSMHdCKMRHNOpenHandle[
    fsSettings -> {
...
spectrum    = FScSMHdCKMRHNCalculateSpectrum[handle];
observables = FScSMHdCKMRHNCalculateObservables[handle];
FScSMHdCKMRHNCloseHandle[handle];
