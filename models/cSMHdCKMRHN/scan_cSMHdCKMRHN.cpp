...
{
   std::cout <<
      "Usage: scan_cSMHdCKMRHN.x [options]\n"
      "Options:\n"
      "  --LambdaIN=<value>\n"
      "  --Qin=<value>\n"
      "  --QEWSB=<value>\n"
...
struct cSMHdCKMRHN_scan_result {
   Spectrum_generator_problems problems;
   double higgs{0.};
};

template <class solver_type>
cSMHdCKMRHN_scan_result run_parameter_point(const softsusy::QedQcd& qedqcd,
   cSMHdCKMRHN_input_parameters& input)
{
   ...
   cSMHdCKMRHN_scan_result result;
...
void scan(int solver_type, cSMHdCKMRHN_input_parameters& input,
