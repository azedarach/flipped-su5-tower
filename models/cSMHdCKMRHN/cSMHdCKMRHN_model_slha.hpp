...
class cSMHdCKMRHN_slha : public Model {
public:
   explicit cSMHdCKMRHN_slha(const cSMHdCKMRHN_input_parameters& input_ = cSMHdCKMRHN_input_parameters());
   explicit cSMHdCKMRHN_slha(const Model&, bool do_convert_masses_to_slha = true);
   cSMHdCKMRHN_slha(const cSMHdCKMRHN_slha&) = default;
   cSMHdCKMRHN_slha(cSMHdCKMRHN_slha&&) = default;
   virtual ~cSMHdCKMRHN_slha() = default;
   cSMHdCKMRHN_slha& operator=(const cSMHdCKMRHN_slha&) = default;
   cSMHdCKMRHN_slha& operator=(cSMHdCKMRHN_slha&&) = default;
   ...
   const cSMHdCKMRHN_physical& get_physical_slha() const; ///< returns pole masses to SLHA convention
   cSMHdCKMRHN_physical& get_physical_slha(); ///< returns pole masses to SLHA convention
...
private:
   cSMHdCKMRHN_physical physical_slha{}; ///< contains the pole masses and mixings in slha convention
...
template <class Model>
cSMHdCKMRHN_slha<Model>::cSMHdCKMRHN_slha(const cSMHdCKMRHN_input_parameters& input_)
   : Model(input_)
{
}
 ...
 */
template <class Model>
cSMHdCKMRHN_slha<Model>::cSMHdCKMRHN_slha(const Model& model_,
...
template <class Model>
void cSMHdCKMRHN_slha<Model>::clear()
{
   Model::clear();
   physical_slha.clear();
}
...
template <class Model>
void cSMHdCKMRHN_slha<Model>::calculate_spectrum()
{
...
template <class Model>
void cSMHdCKMRHN_slha<Model>::convert_to_slha()
{
...
template <class Model>
void cSMHdCKMRHN_slha<Model>::calculate_ckm_matrix()
{
...
template <class Model>
void cSMHdCKMRHN_slha<Model>::calculate_pmns_matrix()
{
 ...
 */
template <class Model>
void cSMHdCKMRHN_slha<Model>::convert_yukawa_couplings_to_slha()
{
 ...
 */
template <class Model>
void cSMHdCKMRHN_slha<Model>::convert_trilinear_couplings_to_slha()
{
 ...
 */
template <class Model>
void cSMHdCKMRHN_slha<Model>::convert_soft_squared_masses_to_slha()
{

}

template <class Model>
const cSMHdCKMRHN_physical& cSMHdCKMRHN_slha<Model>::get_physical_slha() const
{
   return physical_slha;
}

template <class Model>
cSMHdCKMRHN_physical& cSMHdCKMRHN_slha<Model>::get_physical_slha()
{
   return physical_slha;
}

template <class Model>
void cSMHdCKMRHN_slha<Model>::print(std::ostream& ostr) const
{
   Model::print(ostr);
...
template <class Model>
void cSMHdCKMRHN_slha<Model>::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

template <class Model>
std::ostream& operator<<(std::ostream& ostr, const cSMHdCKMRHN_slha<Model>& model)
{
   model.print(ostr);
   return ostr;
}
