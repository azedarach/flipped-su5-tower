...
#ifndef cSMHdCKMRHN_EFFECTIVE_COUPLINGS_H
#define cSMHdCKMRHN_EFFECTIVE_COUPLINGS_H
...
class cSMHdCKMRHN_effective_couplings {
public:
   cSMHdCKMRHN_effective_couplings(const cSMHdCKMRHN_mass_eigenstates&,
   ...
   void set_model(const cSMHdCKMRHN_mass_eigenstates& model_);
