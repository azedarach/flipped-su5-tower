 ...
 */
double cSMHdCKMRHN_susy_parameters::calc_beta_Lambdax_1_loop(const Susy_traces& susy_traces) const
{
   ...
   beta_Lambdax = Re(oneOver16PiSqr*(0.27*Quad(g1) + 2.25*Quad(g2) - 9*Lambdax*
      ...
      - traceYeAdjYeYeAdjYe - 3*traceYuAdjYuYuAdjYu - traceYvAdjYvYvAdjYv + 3*
      traceYdAdjYd*Lambdax + traceYeAdjYe*Lambdax + 3*traceYuAdjYu*Lambdax +
      traceYvAdjYv*Lambdax + 3*Sqr(Lambdax))));
 ...
 */
double cSMHdCKMRHN_susy_parameters::calc_beta_Lambdax_2_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
   ...
   const double traceYeAdjYeYeAdjYvYvAdjYe = TRACE_STRUCT.
      traceYeAdjYeYeAdjYvYvAdjYe;
   const double traceYeAdjYvYvAdjYeYeAdjYe = TRACE_STRUCT.
      traceYeAdjYvYvAdjYeYeAdjYe;
   const double traceYeAdjYvYvAdjYvYvAdjYe = TRACE_STRUCT.
      traceYeAdjYvYvAdjYvYvAdjYe;
   const double traceYuAdjYuYuAdjYuYuAdjYu = TRACE_STRUCT.
      traceYuAdjYuYuAdjYuYuAdjYu;
   const double traceYvAdjYvYvAdjYvYvAdjYv = TRACE_STRUCT.
      traceYvAdjYvYvAdjYvYvAdjYv;
   ...
   beta_Lambdax = Re(twoLoop*(60*traceYdAdjYdYdAdjYdYdAdjYd - 24*
      ...
      traceYdAdjYuYuAdjYuYuAdjYd + 20*traceYeAdjYeYeAdjYeYeAdjYe - 8*
      traceYeAdjYeYeAdjYvYvAdjYe + 4*traceYeAdjYvYvAdjYeYeAdjYe - 4*
      traceYeAdjYvYvAdjYvYvAdjYe + 60*traceYuAdjYuYuAdjYuYuAdjYu + 20*
      traceYvAdjYvYvAdjYvYvAdjYv - 78*Cube(Lambdax) - 3*traceYdAdjYdYdAdjYd*
      Lambdax - 42*traceYdAdjYuYuAdjYd*Lambdax - traceYeAdjYeYeAdjYe*Lambdax -
      14*traceYeAdjYvYvAdjYe*Lambdax - 3*traceYuAdjYuYuAdjYu*Lambdax -
      traceYvAdjYvYvAdjYv*Lambdax - 3.411*Power6(g1) + 38.125*Power6(g2) -
      0.125*(36*traceYdAdjYd + 12*traceYeAdjYe + 36*traceYuAdjYu + 12*
      traceYvAdjYv + 73*Lambdax)*Quad(g2) + 1.5*Lambdax*(15*traceYdAdjYd + 5*
      traceYeAdjYe + 15*traceYuAdjYu + 5*traceYvAdjYv + 36*Lambdax)*Sqr(g2) -
      0.015*Quad(g1)*(-60*traceYdAdjYd + 300*traceYeAdjYe + 228*traceYuAdjYu +
      12*traceYvAdjYv - 629*Lambdax + 559*Sqr(g2)) - 64*traceYdAdjYdYdAdjYd*Sqr
      (g3) - 64*traceYuAdjYuYuAdjYu*Sqr(g3) + 80*traceYdAdjYd*Lambdax*Sqr(g3) +
      80*traceYuAdjYu*Lambdax*Sqr(g3) - 72*traceYdAdjYd*Sqr(Lambdax) - 24*
      traceYeAdjYe*Sqr(Lambdax) - 72*traceYuAdjYu*Sqr(Lambdax) - 24*
      traceYvAdjYv*Sqr(Lambdax) - 0.025*Sqr(g1)*(289*Quad(g2) - 6*(36*
      traceYdAdjYd + 44*traceYeAdjYe + 84*traceYuAdjYu - 4*traceYvAdjYv + 39*
      Lambdax)*Sqr(g2) - 4*(16*traceYdAdjYdYdAdjYd - 48*traceYeAdjYeYeAdjYe -
      32*traceYuAdjYuYuAdjYu + 25*traceYdAdjYd*Lambdax + 75*traceYeAdjYe*
      Lambdax + 85*traceYuAdjYu*Lambdax + 15*traceYvAdjYv*Lambdax + 108*Sqr(
      Lambdax)))));
 ...
 */
double cSMHdCKMRHN_susy_parameters::calc_beta_Lambdax_3_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double cSMHdCKMRHN_susy_parameters::calc_beta_Lambdax_4_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
