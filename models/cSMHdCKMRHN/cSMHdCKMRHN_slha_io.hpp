...
#ifndef cSMHdCKMRHN_SLHA_IO_H
#define cSMHdCKMRHN_SLHA_IO_H
...
public:
   ...
   void fill(cSMHdCKMRHN_input_parameters&) const;
   ...
   template <class Model> void set_extra(const cSMHdCKMRHN_slha<Model>&, const cSMHdCKMRHN_scales&, const cSMHdCKMRHN_observables&);
   void set_input(const cSMHdCKMRHN_input_parameters&);
   ...
   static void fill_minpar_tuple(cSMHdCKMRHN_input_parameters&, int, double);
   static void fill_extpar_tuple(cSMHdCKMRHN_input_parameters&, int, double);
   static void fill_imminpar_tuple(cSMHdCKMRHN_input_parameters&, int, double);
   static void fill_imextpar_tuple(cSMHdCKMRHN_input_parameters&, int, double);

   template <class Model>
   static void fill_slhaea(SLHAea::Coll&, const cSMHdCKMRHN_slha<Model>&, const softsusy::QedQcd&, const cSMHdCKMRHN_scales&, const cSMHdCKMRHN_observables&);

   template <class Model>
   static SLHAea::Coll fill_slhaea(const cSMHdCKMRHN_slha<Model>&, const softsusy::QedQcd&, const cSMHdCKMRHN_scales&, const cSMHdCKMRHN_observables&);

private:
   SLHA_io slha_io; ///< SLHA io class
   bool print_imaginary_parts_of_majorana_mixings;

   void set_extpar(const cSMHdCKMRHN_input_parameters&);
   void set_imminpar(const cSMHdCKMRHN_input_parameters&);
   void set_imextpar(const cSMHdCKMRHN_input_parameters&);
   void set_minpar(const cSMHdCKMRHN_input_parameters&);
 ...
 */
template <class Model>
void cSMHdCKMRHN_slha_io::fill(cSMHdCKMRHN_slha<Model>& model) const
{
...
template <class Model>
void cSMHdCKMRHN_slha_io::fill_slhaea(
   SLHAea::Coll& slhaea, const cSMHdCKMRHN_slha<Model>& model,
   const softsusy::QedQcd& qedqcd, const cSMHdCKMRHN_scales& scales,
   const cSMHdCKMRHN_observables& observables)
{
   cSMHdCKMRHN_slha_io slha_io;
   const cSMHdCKMRHN_input_parameters& input = model.get_input();
...
template <class Model>
SLHAea::Coll cSMHdCKMRHN_slha_io::fill_slhaea(
   const cSMHdCKMRHN_slha<Model>& model, const softsusy::QedQcd& qedqcd,
   const cSMHdCKMRHN_scales& scales, const cSMHdCKMRHN_observables& observables)
{
   SLHAea::Coll slhaea;
   cSMHdCKMRHN_slha_io::fill_slhaea(slhaea, model, qedqcd, scales, observables);
 ...
 */
template <class Model>
void cSMHdCKMRHN_slha_io::set_model_parameters(const cSMHdCKMRHN_slha<Model>& model)
{
   {
 ...
 */
template <class Model>
void cSMHdCKMRHN_slha_io::set_extra(
   const cSMHdCKMRHN_slha<Model>& model, const cSMHdCKMRHN_scales& scales,
   const cSMHdCKMRHN_observables& observables)
{
 ...
 */
template <class... Ts>
void cSMHdCKMRHN_slha_io::set_spectrum(const std::tuple<Ts...>& models)
{
   Set_spectrum<cSMHdCKMRHN_slha_io> ss(this);
 ...
 */
template <class T>
void cSMHdCKMRHN_slha_io::set_spectrum(const cSMHdCKMRHN<T>& model)
{
 ...
 */
template <class Model>
void cSMHdCKMRHN_slha_io::set_spectrum(const cSMHdCKMRHN_slha<Model>& model)
{
   const cSMHdCKMRHN_physical physical(model.get_physical_slha());
