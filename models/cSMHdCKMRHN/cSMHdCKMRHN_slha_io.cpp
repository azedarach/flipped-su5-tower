...
cSMHdCKMRHN_slha_io::cSMHdCKMRHN_slha_io()
   : slha_io()
   , print_imaginary_parts_of_majorana_mixings(false)
{
}

void cSMHdCKMRHN_slha_io::clear()
{
   slha_io.clear();
}

void cSMHdCKMRHN_slha_io::set_print_imaginary_parts_of_majorana_mixings(bool flag)
{
 ...
 */
void cSMHdCKMRHN_slha_io::set_extpar(const cSMHdCKMRHN_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void cSMHdCKMRHN_slha_io::set_imminpar(const cSMHdCKMRHN_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void cSMHdCKMRHN_slha_io::set_imextpar(const cSMHdCKMRHN_input_parameters& input)
{
 ...
 */
void cSMHdCKMRHN_slha_io::set_modsel(const SLHA_io::Modsel& modsel)
{
 ...
 * @param input struct of input parameters
 */
void cSMHdCKMRHN_slha_io::set_minpar(const cSMHdCKMRHN_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void cSMHdCKMRHN_slha_io::set_input(const cSMHdCKMRHN_input_parameters& input)
{
   set_minpar(input);
   set_extpar(input);
   set_imminpar(input);
 ...
 */
void cSMHdCKMRHN_slha_io::set_physical_input(const Physical_input& input)
{
 ...
 */
void cSMHdCKMRHN_slha_io::set_settings(const Spectrum_generator_settings& settings)
{
 ...
 */
void cSMHdCKMRHN_slha_io::set_sminputs(const softsusy::QedQcd& qedqcd)
{
 ...
 */
void cSMHdCKMRHN_slha_io::set_spinfo(const Spectrum_generator_problems& problems)
{
 ...
 * @param problems struct with parameter point problems
 */
void cSMHdCKMRHN_slha_io::set_spinfo(const Problems& problems)
{
   set_spinfo(problems.get_problem_strings(), problems.get_warning_strings());
}
 ...
 */
void cSMHdCKMRHN_slha_io::set_spinfo(
 ...
 */
void cSMHdCKMRHN_slha_io::set_mass(const cSMHdCKMRHN_physical& physical,
 ...
 */
void cSMHdCKMRHN_slha_io::set_mixing_matrices(const cSMHdCKMRHN_physical& physical,
...
void cSMHdCKMRHN_slha_io::set_ckm(
...
void cSMHdCKMRHN_slha_io::set_pmns(
...
void cSMHdCKMRHN_slha_io::set_model_parameters(const standard_model::Standard_model& model)
{
   {
...
void cSMHdCKMRHN_slha_io::set_mass(const standard_model::Standard_model_physical& physical)
{
   std::ostringstream mass;
...
void cSMHdCKMRHN_slha_io::set_mixing_matrices(const standard_model::Standard_model_physical& physical)
{
...
void cSMHdCKMRHN_slha_io::set_spectrum(const standard_model::Standard_model& model)
{
 ...
 */
void cSMHdCKMRHN_slha_io::write_to(const std::string& output) const
{
   if (output == "-")
 ...
 */
double cSMHdCKMRHN_slha_io::get_parameter_output_scale() const
{
 ...
 */
void cSMHdCKMRHN_slha_io::read_from_file(const std::string& file_name)
{
 ...
 */
void cSMHdCKMRHN_slha_io::read_from_source(const std::string& source)
{
 ...
 */
void cSMHdCKMRHN_slha_io::read_from_stream(std::istream& istr)
{
 ...
 */
void cSMHdCKMRHN_slha_io::fill(cSMHdCKMRHN_input_parameters& input) const
{
   ...
   slha_io.read_block("MvIN", input.MvInput);
 ...
 */
void cSMHdCKMRHN_slha_io::fill_drbar_parameters(cSMHdCKMRHN_mass_eigenstates& model) const
{
 ...
 * @param model model class to be filled
 */
void cSMHdCKMRHN_slha_io::fill(cSMHdCKMRHN_mass_eigenstates& model) const
{
 ...
 */
void cSMHdCKMRHN_slha_io::fill(Physical_input& input) const
{
   slha_io.fill(input);
}
 ...
 */
void cSMHdCKMRHN_slha_io::fill(Spectrum_generator_settings& settings) const
{
   slha_io.fill(settings);
}

void cSMHdCKMRHN_slha_io::fill_minpar_tuple(cSMHdCKMRHN_input_parameters& input,
...
void cSMHdCKMRHN_slha_io::fill_extpar_tuple(cSMHdCKMRHN_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
...
void cSMHdCKMRHN_slha_io::fill_imminpar_tuple(cSMHdCKMRHN_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
...
void cSMHdCKMRHN_slha_io::fill_imextpar_tuple(cSMHdCKMRHN_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
 ...
 */
void cSMHdCKMRHN_slha_io::fill_physical(cSMHdCKMRHN_physical& physical) const
{
   {
 ...
 */
double cSMHdCKMRHN_slha_io::read_scale() const
{
