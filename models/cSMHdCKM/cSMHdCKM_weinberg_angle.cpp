...
#define CLASSNAME cSMHdCKM_weinberg_angle
 ...
 */
CLASSNAME::cSMHdCKM_weinberg_angle(
...
void CLASSNAME::set_model(const cSMHdCKM_mass_eigenstates* model_)
{
   model = model_;
}
...
{
   const auto gY = MODEL->get_g1() * cSMHdCKM_info::normalization_g1;
   const auto g2 = MODEL->get_g2() * cSMHdCKM_info::normalization_g2;
