...
cSMHdCKM_slha_io::cSMHdCKM_slha_io()
   : slha_io()
   , print_imaginary_parts_of_majorana_mixings(false)
{
}

void cSMHdCKM_slha_io::clear()
{
   slha_io.clear();
}

void cSMHdCKM_slha_io::set_print_imaginary_parts_of_majorana_mixings(bool flag)
{
 ...
 */
void cSMHdCKM_slha_io::set_extpar(const cSMHdCKM_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void cSMHdCKM_slha_io::set_imminpar(const cSMHdCKM_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void cSMHdCKM_slha_io::set_imextpar(const cSMHdCKM_input_parameters& input)
{
 ...
 */
void cSMHdCKM_slha_io::set_modsel(const SLHA_io::Modsel& modsel)
{
 ...
 * @param input struct of input parameters
 */
void cSMHdCKM_slha_io::set_minpar(const cSMHdCKM_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void cSMHdCKM_slha_io::set_input(const cSMHdCKM_input_parameters& input)
{
   set_minpar(input);
   set_extpar(input);
   set_imminpar(input);
 ...
 */
void cSMHdCKM_slha_io::set_physical_input(const Physical_input& input)
{
 ...
 */
void cSMHdCKM_slha_io::set_settings(const Spectrum_generator_settings& settings)
{
 ...
 */
void cSMHdCKM_slha_io::set_sminputs(const softsusy::QedQcd& qedqcd)
{
 ...
 */
void cSMHdCKM_slha_io::set_spinfo(const Spectrum_generator_problems& problems)
{
 ...
 * @param problems struct with parameter point problems
 */
void cSMHdCKM_slha_io::set_spinfo(const Problems& problems)
{
   set_spinfo(problems.get_problem_strings(), problems.get_warning_strings());
}
 ...
 */
void cSMHdCKM_slha_io::set_spinfo(
   ...
   const std::vector<std::string>& warnings)
{
   ...
   spinfo << FORMAT_SPINFO(5, cSMHdCKM_info::model_name)
 ...
 */
void cSMHdCKM_slha_io::set_mass(const cSMHdCKM_physical& physical,
 ...
 */
void cSMHdCKM_slha_io::set_mixing_matrices(const cSMHdCKM_physical& physical,
...
void cSMHdCKM_slha_io::set_pmns(
...
void cSMHdCKM_slha_io::set_model_parameters(const standard_model::Standard_model& model)
{
   {
...
void cSMHdCKM_slha_io::set_mass(const standard_model::Standard_model_physical& physical)
{
   std::ostringstream mass;
...
void cSMHdCKM_slha_io::set_mixing_matrices(const standard_model::Standard_model_physical& physical)
{
...
void cSMHdCKM_slha_io::set_spectrum(const standard_model::Standard_model& model)
{
 ...
 */
void cSMHdCKM_slha_io::write_to(const std::string& output) const
{
   if (output == "-")
 ...
 */
double cSMHdCKM_slha_io::get_parameter_output_scale() const
{
 ...
 */
void cSMHdCKM_slha_io::read_from_file(const std::string& file_name)
{
 ...
 */
void cSMHdCKM_slha_io::read_from_source(const std::string& source)
{
 ...
 */
void cSMHdCKM_slha_io::read_from_stream(std::istream& istr)
{
 ...
 */
void cSMHdCKM_slha_io::fill(cSMHdCKM_input_parameters& input) const
{
 ...
 */
void cSMHdCKM_slha_io::fill_drbar_parameters(cSMHdCKM_mass_eigenstates& model) const
{
 ...
 * @param model model class to be filled
 */
void cSMHdCKM_slha_io::fill(cSMHdCKM_mass_eigenstates& model) const
{
   fill_drbar_parameters(model);

   cSMHdCKM_physical physical_hk;
 ...
 */
void cSMHdCKM_slha_io::fill(Physical_input& input) const
{
   slha_io.fill(input);
}
 ...
 */
void cSMHdCKM_slha_io::fill(Spectrum_generator_settings& settings) const
{
   slha_io.fill(settings);
}

void cSMHdCKM_slha_io::fill_minpar_tuple(cSMHdCKM_input_parameters& input,
...
void cSMHdCKM_slha_io::fill_extpar_tuple(cSMHdCKM_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
...
void cSMHdCKM_slha_io::fill_imminpar_tuple(cSMHdCKM_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
...
void cSMHdCKM_slha_io::fill_imextpar_tuple(cSMHdCKM_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
 ...
 */
void cSMHdCKM_slha_io::fill_physical(cSMHdCKM_physical& physical) const
{
   {
 ...
 */
double cSMHdCKM_slha_io::read_scale() const
{
