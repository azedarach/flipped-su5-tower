 ...
 * to be complex.
 */
void cSMHdCKM_physical::convert_to_hk()
{
 ...
 * be negative.
 */
void cSMHdCKM_physical::convert_to_slha()
{

}

Eigen::ArrayXd cSMHdCKM_physical::get() const
{
...
void cSMHdCKM_physical::set(const Eigen::ArrayXd& pars)
{
   set_masses(pars);
...
Eigen::ArrayXd cSMHdCKM_physical::get_masses() const
{
...
void cSMHdCKM_physical::set_masses(const Eigen::ArrayXd& pars)
{
   MVG = pars(0);
   MHm = pars(1);
   MFv(0) = pars(2);
...
void cSMHdCKM_physical::print(std::ostream& ostr) const
{
   ostr << "----------------------------------------\n"
           "pole masses:\n"
           "----------------------------------------\n";
...
std::ostream& operator<<(std::ostream& ostr, const cSMHdCKM_physical& phys_pars)
{
