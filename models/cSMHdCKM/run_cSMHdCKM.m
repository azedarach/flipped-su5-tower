Get["models/cSMHdCKM/cSMHdCKM_librarylink.m"];

handle = FScSMHdCKMOpenHandle[
    fsSettings -> {
...
spectrum    = FScSMHdCKMCalculateSpectrum[handle];
observables = FScSMHdCKMCalculateObservables[handle];
FScSMHdCKMCloseHandle[handle];
