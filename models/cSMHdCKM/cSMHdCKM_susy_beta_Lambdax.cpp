 ...
 */
double cSMHdCKM_susy_parameters::calc_beta_Lambdax_1_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double cSMHdCKM_susy_parameters::calc_beta_Lambdax_2_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
 ...
 */
double cSMHdCKM_susy_parameters::calc_beta_Lambdax_3_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double cSMHdCKM_susy_parameters::calc_beta_Lambdax_4_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
