...
cSMHdCKM_low_scale_constraint<Two_scale>::cSMHdCKM_low_scale_constraint(
...
void cSMHdCKM_low_scale_constraint<Two_scale>::apply()
{
   check_model_ptr();
...
const Eigen::Matrix<std::complex<double>,3,3>& cSMHdCKM_low_scale_constraint<Two_scale>::get_pmns()
{
   return pmns;
}

double cSMHdCKM_low_scale_constraint<Two_scale>::get_scale() const
{
   return scale;
}

double cSMHdCKM_low_scale_constraint<Two_scale>::get_initial_scale_guess() const
{
   return initial_scale_guess;
}

void cSMHdCKM_low_scale_constraint<Two_scale>::set_model(Model* model_)
{
   model = cast_model<cSMHdCKM<Two_scale>*>(model_);
}

void cSMHdCKM_low_scale_constraint<Two_scale>::set_sm_parameters(
   const softsusy::QedQcd& qedqcd_)
{
   qedqcd = qedqcd_;
}

const softsusy::QedQcd& cSMHdCKM_low_scale_constraint<Two_scale>::get_sm_parameters() const
{
   return qedqcd;
}

void cSMHdCKM_low_scale_constraint<Two_scale>::clear()
{
   scale = 0.;
...
void cSMHdCKM_low_scale_constraint<Two_scale>::initialize()
{
   check_model_ptr();
...
void cSMHdCKM_low_scale_constraint<Two_scale>::update_scale()
{
   check_model_ptr();
...
void cSMHdCKM_low_scale_constraint<Two_scale>::calculate_threshold_corrections()
{
   check_model_ptr();
...
double cSMHdCKM_low_scale_constraint<Two_scale>::calculate_theta_w()
{
   check_model_ptr();
...
void cSMHdCKM_low_scale_constraint<Two_scale>::calculate_DRbar_gauge_couplings()
{
   check_model_ptr();
...
double cSMHdCKM_low_scale_constraint<Two_scale>::calculate_delta_alpha_em(double alphaEm) const
{
   check_model_ptr();
...
double cSMHdCKM_low_scale_constraint<Two_scale>::calculate_delta_alpha_s(double alphaS) const
{
   check_model_ptr();
...
double cSMHdCKM_low_scale_constraint<Two_scale>::calculate_alpha_s_SM5_at(
...
void cSMHdCKM_low_scale_constraint<Two_scale>::calculate_running_SM_masses()
{
   check_model_ptr();
...
void cSMHdCKM_low_scale_constraint<Two_scale>::calculate_Yu_DRbar()
{
   check_model_ptr();
...
void cSMHdCKM_low_scale_constraint<Two_scale>::calculate_Yd_DRbar()
{
   check_model_ptr();
...
{
   if (!model)
      throw SetupError("cSMHdCKM_low_scale_constraint<Two_scale>: "
