...
#ifndef cSMHdCKM_TWO_SCALE_LOW_SCALE_CONSTRAINT_H
#define cSMHdCKM_TWO_SCALE_LOW_SCALE_CONSTRAINT_H

#include "cSMHdCKM_low_scale_constraint.hpp"
...
template<>
class cSMHdCKM_low_scale_constraint<Two_scale> : public Single_scale_constraint {
public:
   cSMHdCKM_low_scale_constraint() = default;
   cSMHdCKM_low_scale_constraint(cSMHdCKM<Two_scale>*, const softsusy::QedQcd&);
   virtual ~cSMHdCKM_low_scale_constraint() = default;
   virtual void apply() override;
   virtual double get_scale() const override;
   virtual std::string name() const override { return "cSMHdCKM low-scale constraint"; }
