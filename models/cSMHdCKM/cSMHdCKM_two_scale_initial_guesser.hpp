...
#ifndef cSMHdCKM_TWO_SCALE_INITIAL_GUESSER_H
#define cSMHdCKM_TWO_SCALE_INITIAL_GUESSER_H

#include "cSMHdCKM_initial_guesser.hpp"
...
/**
 * @class cSMHdCKM_initial_guesser<Two_scale>
 * @brief initial guesser for the cSMHdCKM
 */

template<>
class cSMHdCKM_initial_guesser<Two_scale> : public Initial_guesser {
public:
   cSMHdCKM_initial_guesser(cSMHdCKM<Two_scale>*,
                               const softsusy::QedQcd&,
                               const cSMHdCKM_low_scale_constraint<Two_scale>&,
                               const cSMHdCKM_susy_scale_constraint<Two_scale>&,
                               const cSMHdCKM_high_scale_constraint<Two_scale>&);
   virtual ~cSMHdCKM_initial_guesser() = default;
...
private:
   cSMHdCKM<Two_scale>* model{nullptr}; ///< pointer to model class
   ...
   cSMHdCKM_susy_scale_constraint<Two_scale> susy_constraint{};
   cSMHdCKM_high_scale_constraint<Two_scale> high_constraint{};
