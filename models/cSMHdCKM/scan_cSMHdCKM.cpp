...
struct cSMHdCKM_scan_result {
   Spectrum_generator_problems problems;
   double higgs{0.};
};

template <class solver_type>
cSMHdCKM_scan_result run_parameter_point(const softsusy::QedQcd& qedqcd,
   cSMHdCKM_input_parameters& input)
{
...
void scan(int solver_type, cSMHdCKM_input_parameters& input,
