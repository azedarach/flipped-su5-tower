...
{
   std::cout <<
      "Usage: run_cmd_line_cSMHdCKM.x [options]\n"
      "Options:\n"
      "  --LambdaIN=<value>\n"
      "  --Qin=<value>\n"
      "  --QEWSB=<value>\n"
...
int run_solver(const cSMHdCKM_input_parameters& input)
{
   ...
   // SLHA output
   SLHAea::Coll slhaea(cSMHdCKM_slha_io::fill_slhaea(
...
int run(int solver_type, const cSMHdCKM_input_parameters& input)
{
   int exit_code = 0;
