...
namespace cSMHdCKM_info {
   ...
   const std::array<std::string, NUMBER_OF_PARAMETERS> parameter_names = {"g1",
      ...
      "Im(Ye(2,1))", "Re(Ye(2,2))", "Im(Ye(2,2))", "Re(Yu(0,0))", "Im(Yu(0,0))",
      "Re(Yu(0,1))", "Im(Yu(0,1))", "Re(Yu(0,2))", "Im(Yu(0,2))", "Re(Yu(1,0))",
      "Im(Yu(1,0))", "Re(Yu(1,1))", "Im(Yu(1,1))", "Re(Yu(1,2))", "Im(Yu(1,2))",
      "Re(Yu(2,0))", "Im(Yu(2,0))", "Re(Yu(2,1))", "Im(Yu(2,1))", "Re(Yu(2,2))",
      "Im(Yu(2,2))", "mu2", "v"};
   ...
   const std::string model_name = "cSMHdCKM";
