...
#ifndef cSMHdCKM_EFFECTIVE_COUPLINGS_H
#define cSMHdCKM_EFFECTIVE_COUPLINGS_H
...
class cSMHdCKM_effective_couplings {
public:
   cSMHdCKM_effective_couplings(const cSMHdCKM_mass_eigenstates&,
   ...
   void set_model(const cSMHdCKM_mass_eigenstates& model_);
