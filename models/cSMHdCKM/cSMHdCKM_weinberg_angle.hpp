...
#ifndef cSMHdCKM_WEINBERG_ANGLE_H
#define cSMHdCKM_WEINBERG_ANGLE_H
...
public:
   ...
   cSMHdCKM_weinberg_angle(const cSMHdCKM_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const cSMHdCKM_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const cSMHdCKM_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
