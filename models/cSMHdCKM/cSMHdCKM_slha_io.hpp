...
#ifndef cSMHdCKM_SLHA_IO_H
#define cSMHdCKM_SLHA_IO_H
...
public:
   ...
   void fill(cSMHdCKM_input_parameters&) const;
   void fill(cSMHdCKM_mass_eigenstates&) const;
   template <class Model> void fill(cSMHdCKM_slha<Model>&) const;
   ...
   template <class Model> void set_extra(const cSMHdCKM_slha<Model>&, const cSMHdCKM_scales&, const cSMHdCKM_observables&);
   void set_input(const cSMHdCKM_input_parameters&);
   ...
   static void fill_minpar_tuple(cSMHdCKM_input_parameters&, int, double);
   static void fill_extpar_tuple(cSMHdCKM_input_parameters&, int, double);
   static void fill_imminpar_tuple(cSMHdCKM_input_parameters&, int, double);
   static void fill_imextpar_tuple(cSMHdCKM_input_parameters&, int, double);

   template <class Model>
   static void fill_slhaea(SLHAea::Coll&, const cSMHdCKM_slha<Model>&, const softsusy::QedQcd&, const cSMHdCKM_scales&, const cSMHdCKM_observables&);

   template <class Model>
   static SLHAea::Coll fill_slhaea(const cSMHdCKM_slha<Model>&, const softsusy::QedQcd&, const cSMHdCKM_scales&, const cSMHdCKM_observables&);

private:
   SLHA_io slha_io; ///< SLHA io class
   bool print_imaginary_parts_of_majorana_mixings;

   void set_extpar(const cSMHdCKM_input_parameters&);
   void set_imminpar(const cSMHdCKM_input_parameters&);
   void set_imextpar(const cSMHdCKM_input_parameters&);
   void set_minpar(const cSMHdCKM_input_parameters&);
   ...
   void fill_drbar_parameters(cSMHdCKM_mass_eigenstates&) const;
   void fill_physical(cSMHdCKM_physical&) const;
};
 ...
 */
template <class Model>
void cSMHdCKM_slha_io::fill(cSMHdCKM_slha<Model>& model) const
{
   fill(static_cast<cSMHdCKM_mass_eigenstates&>(model));
   fill_physical(model.get_physical_slha());
}

template <class Model>
void cSMHdCKM_slha_io::fill_slhaea(
   SLHAea::Coll& slhaea, const cSMHdCKM_slha<Model>& model,
   const softsusy::QedQcd& qedqcd, const cSMHdCKM_scales& scales,
   const cSMHdCKM_observables& observables)
{
   cSMHdCKM_slha_io slha_io;
   const cSMHdCKM_input_parameters& input = model.get_input();
...
template <class Model>
SLHAea::Coll cSMHdCKM_slha_io::fill_slhaea(
   const cSMHdCKM_slha<Model>& model, const softsusy::QedQcd& qedqcd,
   const cSMHdCKM_scales& scales, const cSMHdCKM_observables& observables)
{
   SLHAea::Coll slhaea;
   cSMHdCKM_slha_io::fill_slhaea(slhaea, model, qedqcd, scales, observables);
 ...
 */
template <class Model>
void cSMHdCKM_slha_io::set_model_parameters(const cSMHdCKM_slha<Model>& model)
{
   {
 ...
 */
template <class Model>
void cSMHdCKM_slha_io::set_extra(
   const cSMHdCKM_slha<Model>& model, const cSMHdCKM_scales& scales,
   const cSMHdCKM_observables& observables)
{
 ...
 */
template <class... Ts>
void cSMHdCKM_slha_io::set_spectrum(const std::tuple<Ts...>& models)
{
   Set_spectrum<cSMHdCKM_slha_io> ss(this);
 ...
 */
template <class T>
void cSMHdCKM_slha_io::set_spectrum(const cSMHdCKM<T>& model)
{
 ...
 */
template <class Model>
void cSMHdCKM_slha_io::set_spectrum(const cSMHdCKM_slha<Model>& model)
{
   const cSMHdCKM_physical physical(model.get_physical_slha());
