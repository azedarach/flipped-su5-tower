...
#ifndef cSMHdCKM_susy_parameters_H
#define cSMHdCKM_susy_parameters_H
...
public:
   ...
   cSMHdCKM_susy_parameters& operator=(const cSMHdCKM_susy_parameters&) = default;
   cSMHdCKM_susy_parameters& operator=(cSMHdCKM_susy_parameters&&) = default;

   virtual Eigen::ArrayXd beta() const override;
   virtual Eigen::ArrayXd get() const override;
   virtual void print(std::ostream&) const;
   virtual void set(const Eigen::ArrayXd&) override;
   const cSMHdCKM_input_parameters& get_input() const;
   cSMHdCKM_input_parameters& get_input();
   void set_input_parameters(const cSMHdCKM_input_parameters&);

   cSMHdCKM_susy_parameters calc_beta() const;
   cSMHdCKM_susy_parameters calc_beta(int) const;
   virtual void clear();
...
private:
   static const int numberOfParameters = 58;
...
std::ostream& operator<<(std::ostream&, const cSMHdCKM_susy_parameters&);
