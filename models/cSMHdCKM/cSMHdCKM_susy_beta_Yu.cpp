 ...
 */
Eigen::Matrix<std::complex<double>,3,3> cSMHdCKM_susy_parameters::calc_beta_Yu_1_loop(const Susy_traces& susy_traces) const
{
   ...
   beta_Yu = (oneOver16PiSqr*(Yu*(3*traceYdAdjYd + traceYeAdjYe + 3*
      ...
      adjoint()*Yd) + 1.5*(Yu*Yu.adjoint()*Yu))).template cast<std::complex<
      double> >();
 ...
 */
Eigen::Matrix<std::complex<double>,3,3> cSMHdCKM_susy_parameters::calc_beta_Yu_2_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
   ...
   beta_Yu = (twoLoop*(0.0016666666666666668*Yu*(1187*Quad(g1) + 5*Sqr(g1)*(75*
      ...
      (g3)) - 75*(46*Quad(g2) + 864*Quad(g3) - 160*(traceYdAdjYd + traceYuAdjYu
      )*Sqr(g3) - 3*Sqr(g2)*(5*(3*traceYdAdjYd + traceYeAdjYe + 3*traceYuAdjYu)
      + 24*Sqr(g3)) + 6*(9*traceYdAdjYdYdAdjYd - 2*traceYdAdjYuYuAdjYd + 3*
      traceYeAdjYeYeAdjYe + 9*traceYuAdjYuYuAdjYu - 2*Sqr(Lambdax)))) + 0.0125*
      (-43*Sqr(g1) + 5*(20*(3*traceYdAdjYd + traceYeAdjYe + 3*traceYuAdjYu) + 9
      *Sqr(g2) - 256*Sqr(g3)))*(Yu*Yd.adjoint()*Yd) + (-0.75*(9*traceYdAdjYd +
      3*traceYeAdjYe + 9*traceYuAdjYu + 8*Lambdax) + 2.7875*Sqr(g1) + 8.4375*
      Sqr(g2) + 16*Sqr(g3))*(Yu*Yu.adjoint()*Yu) + 2.75*(Yu*Yd.adjoint()*Yd*Yd.
      adjoint()*Yd) - 0.25*(Yu*Yd.adjoint()*Yd*Yu.adjoint()*Yu) - Yu*Yu.adjoint
      ()*Yu*Yd.adjoint()*Yd + 1.5*(Yu*Yu.adjoint()*Yu*Yu.adjoint()*Yu))).
 ...
 */
Eigen::Matrix<std::complex<double>,3,3> cSMHdCKM_susy_parameters::calc_beta_Yu_3_loop(const Susy_traces& susy_traces) const
{
 ...
 */
Eigen::Matrix<std::complex<double>,3,3> cSMHdCKM_susy_parameters::calc_beta_Yu_4_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
