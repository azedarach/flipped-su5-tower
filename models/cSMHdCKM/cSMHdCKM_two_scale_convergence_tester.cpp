...
cSMHdCKM_convergence_tester<Two_scale>::cSMHdCKM_convergence_tester(
   cSMHdCKM<Two_scale>* model, double accuracy_goal, const Scale_getter& sg)
   : Convergence_tester_DRbar<cSMHdCKM<Two_scale> >(model, accuracy_goal, sg)
{
}

double cSMHdCKM_convergence_tester<Two_scale>::max_rel_diff() const
{
   const cSMHdCKM<Two_scale>& ol = get_last_iteration_model();
   const cSMHdCKM<Two_scale>& ne = get_current_iteration_model();
