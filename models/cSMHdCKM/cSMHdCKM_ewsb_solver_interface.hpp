...
/**
 * @file cSMHdCKM_ewsb_solver_interface.hpp
 *
 * @brief contains interface for EWSB solver
 *
 * This file was generated at Mon 5 Nov 2018 12:47:52 with FlexibleSUSY
 * 2.2.0 (git commit: fff0745460c710cd894e99b5b50967ac42dc9aba) and SARAH 4.14.0 .
 */

#ifndef cSMHdCKM_EWSB_SOLVER_INTERFACE_H
#define cSMHdCKM_EWSB_SOLVER_INTERFACE_H
...
class cSMHdCKM_ewsb_solver_interface {
public:
   virtual ~cSMHdCKM_ewsb_solver_interface() {}
   ...
   virtual int solve(cSMHdCKM_mass_eigenstates&) = 0;
};
